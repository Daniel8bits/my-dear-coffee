...
export const IconButton = ({className='', ...props}) => {
    return (
        <MaterialIconButton className={'UI-icon-button '+className} {...props}  />
    )
}

export const FloatingButton = ({className='', ...props}) => {
    return (
        <Fab {...props} className={'UI-floating-button '+className} />
    )
}
...
export const GoogleButton = ({onSuccess=null, onFailure=null, children}) => {
    ...
    const GoogleIconSVG = useCallback(() => {
        return (
    ...
    return (
        <GoogleLogin  
            clientId='520999054814-a9tk4v40m3fmc13ujomdj32dsjl0meft.apps.googleusercontent.com'
            render={renderProps => (
                    <Button 
                        className={'UI-google-button '+style.googleButton} 
...
export const Button = forwardRef((
        ...
        disabled=false, startIcon=null, endIcon=null, onClick=null, 
        children}, ref
    ) => {
